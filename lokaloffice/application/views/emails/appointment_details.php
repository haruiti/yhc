...
<body style="font: 13px arial, helvetica, tahoma;">
    <div class="email-container" style="width: 650px; border: 1px solid #eee;">
        ...
        <div id="content" style="padding: 10px 15px;">
            ...
            <a href="http://lokaloffice.yamatohipnoseclinica.com.br/ea_appointment_manager/login" style="width: 600px;">Entre no Portal para verificar se seu agendamento foi concluído</a>
        </div>

        <div id="footer" style="padding: 10px; text-align: center; margin-top: 10px;
                border-top: 1px solid #EEE; background: #FAFAFA;">
            Powered by
            <a href="https://www.yamatohipnoseclinica.com.br/" style="text-decoration: none;">Yamato Soluções de TI</a>
            |
            <a href="http://lokaloffice.com.br/" style="text-decoration: none;">$company_name</a>
        </div>
    </div>
</body>
</html>
