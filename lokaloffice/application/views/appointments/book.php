    ...
    <div id="main" class="container">
        <div class="wrapper row">
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                                ...
                                <div class="form-group">    
                                    <label for="email" class="control-label"><?= lang('email') ?> *</label>
                                        ...
                                        <input type="text" id="email" 
                                            placeholder="Primeiro insira seu e-mail"
                                            class="required form-control" maxlength="120" style="min-width:280px;"/>
                                            <button type="button" id="button-customer-search" class="btn btn-default"><span class="glyphicon glyphicon-search"></span>
                                            <?= lang('search') ?></button>                                        
                                        </div>
                                 </div> 
                            
                                <fieldset disabled id="homeFieldset">
                                <div class="form-group">
                                    <label for="first-name" class="control-label"><?= lang('first_name') ?> *</label>
                                    <input type="text" id="first-name" class="required form-control" maxlength="100" style="background-color: #DCDCDC"/>
                                </div>
                                <div class="form-group">
                                    <label for="last-name" class="control-label"><?= lang('last_name') ?> *</label>
                                    <input type="text" id="last-name" class="required form-control" maxlength="120" style="background-color: #DCDCDC" />
                                </div>
                                <div class="form-group">
                                    <label for="phone-number" class="control-label"><?= lang('phone_number') ?> *</label>
                                    <input type="text" id="phone-number" class="required form-control" maxlength="60" style="background-color: #DCDCDC" />
                                </div>
                                </fieldset>
                            </div>

                            <div class="col-xs-12 col-sm-6">
                            <fieldset disabled id="homeFieldset2">
                                <div class="form-group">
                                    <label for="address" class="control-label"><?= lang('address') ?></label>
                                    <input type="text" id="address" class="form-control" maxlength="120" style="background-color: #DCDCDC" />
                                </div>
                                <div class="form-group">
                                    <label for="city" class="control-label"><?= lang('city') ?></label>
                                    <input type="text" id="city" class="form-control" maxlength="120" style="background-color: #DCDCDC" />
                                </div>
                                <div class="form-group">
                                    <label for="zip-code" class="control-label"><?= lang('zip_code') ?></label>
                                    <input type="text" id="zip-code" class="form-control" maxlength="120" style="background-color: #DCDCDC" />
                                </div>
                                </fieldset>
                                <div class="form-group">
                                    <label for="notes" class="control-label"><?= lang('notes') ?></label>
                                    <textarea id="notes" maxlength="500" class="form-control" rows="3" 
                ...
                <div id="frame-footer">
                    Powered By
                    <a href="https://yamatohipnoseclinica.com.br" target="_blank">Yamato Soluções de TI</a>
                    |
                    ...
                    |
                    <a href="http://lokaloffice.yamatohipnoseclinica.com.br/ea_appointment_manager/login">
