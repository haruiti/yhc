    ...
    exports.registerAppointment = function () {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                var saldoHoras;
                var qtdhoras;
                if(GlobalVariables.appointmentData.id_services==1){
                    qtdhoras=1;
                }
                if(GlobalVariables.appointmentData.id_services==2){
                    qtdhoras=1,5;
                }
                if(GlobalVariables.appointmentData.id_services==3){
                    qtdhoras=2;
                }
                if(GlobalVariables.appointmentData.id_services==4){
                    qtdhoras=3;
                }
