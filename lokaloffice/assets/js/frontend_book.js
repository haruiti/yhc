...
(function (exports) {
    ...
    function _bindEventHandlers() {
        ...
        $('.button-next').click(function () {
            ...
            if ($(this).attr('data-step_index') === '3') {
                ...
                if (!_validateCustomerForm()) {
                    ...
                    var postUrl = GlobalVariables.baseUrl + '/index.php/appointments/ajax_register_customer';
                    ...
                    FrontendBook.updateConfirmFrame(bancoHoras);
        ...
        $('#book-appointment-submit').click(function (event) {
            ...
            FrontendBookApi.registerAppointment();  //Efetua pagamento pelo banco de horas
             
        });
        
        $('#button-customer-search').click(function (event) {


            if (!GeneralFunctions.validateEmail($('#email').val())) {
                $('#form-message').text(EALang.invalid_email);
                ...
                $('#form-message').text(EALang.fields_are_required);

            }
            
            FrontendBookApi.getCustomerData();
     ...
     */
    exports.updateConfirmFrame = function (bancoHoras) {
