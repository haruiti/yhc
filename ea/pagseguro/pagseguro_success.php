...
//$email = 'simonejarouche@hotmail.com'; // Email produção
$email = 'haruiti@hotmail.com'; // Pagseguro sandbox
...
// $url = 'https://ws.pagseguro.uol.com.br/v2/transactions/'.$transactionCode.'?email='.$email.'&token='.$token; //URL Produção
      ...
      catch(Exception $e)
      {
          ...
          echo "<div id=\"message\" class=\"alert alert-danger\" role=\"alert\">";
          echo "  <h4 class=\"alert-heading\">Problema no processo de pagamento! TESTYE</h4>";
          echo "  <p>Houve um erro no processo de conclusão do pagamento</p>";
          echo "  <p class=\"mb-0\">Entre em contato com a Lokal Office e informe o problema.</p>";
          echo "</div>";
      ...
      if($finished==1){
        ...
        echo "  <p class=\"mb-0\">Acesse seu agendamento pelo link <a href=\"http://yamatohipnoseclinica.hostingerapp.com/ea_appointment_manager/login\">Potal Lokal Office</a></p>";
        echo "</div>";
...
<div id="message" class="alert alert-success" role="alert">
  ...
  <p class="mb-0">Acesse seu agendamento pelo link <a href="http://yamatohipnoseclinica.hostingerapp.com/ea_appointment_manager/login">Potal Lokal Office</a></p>;
</div>
