<?php
    ...
    echo "Teste de notificação";
    $servername = "localhost";
    $username = "u894261163_admin";
    $password = "H@ru709192";
    $notificationCode = preg_replace('/[^[:alnum:]-]/','', $_POST["notificationCode"]);
    //$notificationCode ='23A8900057335733560004B33F9BED49E308';
    ...
    $data['email'] = 'haruiti@hotmail.com';
    ...
    if($reference && $status){
        //if ($status == '3'){
            ...
            $sql = "INSERT INTO ea_teste (reference, status) values ('$reference', '$status')";
            ...
            // $sql2 = "UPDATE ea_appointments SET reference='".$start_datetime. "' , end_datetime ='".$end_datetime. "' WHERE id = '".$id_appointment."'";
