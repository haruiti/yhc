...
class Appointments extends CI_Controller {
    ...
    
    {
        try
        {
            ...
            if(strtotime($datetime_limit) > strtotime('now')){ //
              ...
              $hours=$hours+$appointment['id_services'];
    ...
    public function pagSeguroApi(){
        ...
        $data['email'] = 'haruiti@hotmail.com'; //e-mail Roberto
        //$data['email'] = 'simonejarouche@hotmail.com'; //e-mail Lokal
        $data['currency'] = 'BRL';
        ...
        if($_POST['hour']=="1"){
            ...
            $data['itemId1'] = '2';
            $data['itemQuantity1'] = '1';
            $data['itemDescription1'] = 'Aluguel 1 hora e meia';
        ...
        //$data['excludePaymentMethodGroup1'] = ('DEPOSIT');
        //$data['excludePaymentMethodGroup']=["BOLETO"];
