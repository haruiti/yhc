...
<head>
    ...
    <title>Agendamento Registardo</title>
        ...
        <div class="wrapper row">
            <div id="success-frame" class="frame-container
                ...
                <div class="col-xs-12 col-sm-10">
                    <?php
                        echo '
                            <h3>Agendamento concluído! Porém, só estará ativo após conclusão do pagamento.</h3>
                            <p>Detalhes do agendamento foram enviados a você</p>
